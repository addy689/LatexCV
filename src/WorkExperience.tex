...
\cventry{}{\textnormal{PAM \& JOE HANDCRAFTED INC., Charlottetown, PE}}{Volunteer - Software Developer}{Nov 2016 -- Present}{}{
	...
	\begin{itemize}
		...
		\item Developed a suite of .NET WPF and console applications \href{https://github.com/addy689/PamJoeHandcraftedAppSuite}{\emph{[link-to-sourcecode]}} in C\# for handling business processes such as dynamically generating inventory price tags, uploading products to Shopify web store using Flickr API and Shopify API \emph{[in progress]}, and inventory migration utilities between proprietary Inventory Management systems.
		\item Developed an Inventory Transfer Module in Google Apps Script (bound to a GoogleSheet) that tracks inventory movement between warehouses. Incorporated many performance optimizations, such as utilising the caching service and Binary Search Trees for searching through the large inventory data set.
	\end{itemize}}
